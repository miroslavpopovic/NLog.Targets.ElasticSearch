...
namespace NLog.Targets.ElasticSearch
{
    ...
    public class ElasticSearchTarget : TargetWithLayout, IElasticSearchTarget
    {
        ...
        protected override void InitializeTarget()
        {
            ...
            // Default Elasticsearch.net configuration:
            // https://github.com/elastic/elasticsearch-net/blob/master/src/Elasticsearch.Net/Configuration/ConnectionConfiguration.cs
            ...
            _client = new ElasticSearchClient(nodes.First(), Username, Password);
        ...
        private void SendBatch(ICollection<AsyncLogEventInfo> logEvents)
        {
            try
            {
                ...
                if (!result.Success)
                {
                    var errorMessage = result.ErrorMessage ?? "No error message. Enable Trace logging for more information.";
        ...
        private List<object> FormPayload(ICollection<AsyncLogEventInfo> logEvents)
        {
